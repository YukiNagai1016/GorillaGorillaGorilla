//
//  DetailGorillaListViewController.swift
//  GentleGorillaApp
//
...
class DetailGorillaListViewController: UIViewController  {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "toDetailImage" {
            let detailViewController = segue.destination as! GorillaDetailImageViewController
            
            detailViewController.selectedDetailImageName = selectedImageName
