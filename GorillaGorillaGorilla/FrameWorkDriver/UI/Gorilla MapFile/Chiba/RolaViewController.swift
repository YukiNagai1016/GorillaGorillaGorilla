...
class RolaViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // 名前と画像を表示させる
        detailTitleLabel.text = gorillaTitle[3]
        detailImageView.image = gorillaImages[3]
        detailNameLabel.text = gorillaNames[3]
        detailSexLabel.text = gorillaSex[3]
        detailTypeLabel.text = gorillaType[3]
        detailBirthDayLabel.text = gorillaBirthDay[3]
        detailLivingLabel.text = gorillaLiving[3]
        detailDescriptionTextView.text = gorillaDescription[3]
        detailPersonalityTextView.text = gorillaPersonality[3]
    ...
    func makeButton(x: CGFloat, action: Selector )-> UIButton{
        ...
        button.setBackgroundImage(gorillaImages[3], for: UIControlState.normal)
