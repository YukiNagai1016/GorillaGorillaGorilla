...
class MontaViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // 名前と画像を表示させる
        detailTitleLabel.text = gorillaTitle[9]
        detailImageView.image = gorillaImages[9]
        detailNameLabel.text = gorillaNames[9]
        detailSexLabel.text = gorillaSex[9]
        detailTypeLabel.text = gorillaType[9]
        detailBirthDayLabel.text = gorillaBirthDay[9]
        detailLivingLabel.text = gorillaLiving[9]
        detailDescriptionTextView.text = gorillaDescription[9]
        detailPersonalityTextView.text = gorillaPersonality[9]
    ...
    func makeButton(x: CGFloat, action: Selector )-> UIButton{
        ...
        button.setBackgroundImage(gorillaImages[9], for: UIControlState.normal)
