...
class TaroViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // 名前と画像を表示させる
        detailTitleLabel.text = gorillaTitle[8]
        detailImageView.image = gorillaImages[8]
        detailNameLabel.text = gorillaNames[8]
        detailSexLabel.text = gorillaSex[8]
        detailTypeLabel.text = gorillaType[8]
        detailBirthDayLabel.text = gorillaBirthDay[8]
        detailLivingLabel.text = gorillaLiving[8]
        detailDescriptionTextView.text = gorillaDescription[8]
        detailPersonalityTextView.text = gorillaPersonality[8]
    ...
    func makeButton(x: CGFloat, action: Selector )-> UIButton{
        ...
        button.setBackgroundImage(gorillaImages[8], for: UIControlState.normal)
