...
class SyoViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // 名前と画像を表示させる
        detailTitleLabel.text = gorillaTitle[4]
        detailImageView.image = gorillaImages[4]
        detailNameLabel.text = gorillaNames[4]
        detailSexLabel.text = gorillaSex[4]
        detailTypeLabel.text = gorillaType[4]
        detailBirthDayLabel.text = gorillaBirthDay[4]
        detailLivingLabel.text = gorillaLiving[4]
        detailDescriptionTextView.text = gorillaDescription[4]
        detailPersonalityTextView.text = gorillaPersonality[4]
    ...
    func makeButton(x: CGFloat, action: Selector )-> UIButton{
        ...
        button.setBackgroundImage(gorillaImages[4], for: UIControlState.normal)
