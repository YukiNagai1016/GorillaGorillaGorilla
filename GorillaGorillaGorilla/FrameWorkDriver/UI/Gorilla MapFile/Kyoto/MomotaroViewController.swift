...
class MomotaroViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // 名前と画像を表示させる
        detailTitleLabel.text = gorillaTitle[11]
        detailImageView.image = gorillaImages[11]
        detailNameLabel.text = gorillaNames[11]
        detailSexLabel.text = gorillaSex[11]
        detailTypeLabel.text = gorillaType[11]
        detailBirthDayLabel.text = gorillaBirthDay[11]
        detailLivingLabel.text = gorillaLiving[11]
        detailDescriptionTextView.text = gorillaDescription[11]
        detailPersonalityTextView.text = gorillaPersonality[11]
    ...
    func makeButton(x: CGFloat, action: Selector )-> UIButton{
        ...
        button.setBackgroundImage(gorillaImages[11], for: UIControlState.normal)
