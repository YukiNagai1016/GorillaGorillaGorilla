...
class GenkiViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // 名前と画像を表示させる
        detailTitleLabel.text = gorillaTitle[6]
        detailImageView.image = gorillaImages[6]
        detailNameLabel.text = gorillaNames[6]
        detailSexLabel.text = gorillaSex[6]
        detailTypeLabel.text = gorillaType[6]
        detailBirthDayLabel.text = gorillaBirthDay[6]
        detailLivingLabel.text = gorillaLiving[6]
        detailDescriptionTextView.text = gorillaDescription[6]
        detailPersonalityTextView.text = gorillaPersonality[6]
    ...
    func makeButton(x: CGFloat, action: Selector )-> UIButton{
        ...
        button.setBackgroundImage(gorillaImages[6], for: UIControlState.normal)
