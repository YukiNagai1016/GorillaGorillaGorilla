...
class GentaroViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // 名前と画像を表示させる
        detailTitleLabel.text = gorillaTitle[16]
        detailImageView.image = gorillaImages[16]
        detailNameLabel.text = gorillaNames[16]
        detailSexLabel.text = gorillaSex[16]
        detailTypeLabel.text = gorillaType[16]
        detailBirthDayLabel.text = gorillaBirthDay[16]
        detailLivingLabel.text = gorillaLiving[16]
        detailDescriptionTextView.text = gorillaDescription[16]
        detailPersonalityTextView.text = gorillaPersonality[16]
    ...
    func makeButton(x: CGFloat, action: Selector )-> UIButton{
        ...
        button.setBackgroundImage(gorillaImages[16], for: UIControlState.normal)
