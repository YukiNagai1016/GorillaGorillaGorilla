...
class DonViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // 名前と画像を表示させる
        detailTitleLabel.text = gorillaTitle[0]
        detailImageView.image = gorillaImages[0]
        detailNameLabel.text = gorillaNames[0]
        detailSexLabel.text = gorillaSex[0]
        detailTypeLabel.text = gorillaType[0]
        detailBirthDayLabel.text = gorillaBirthDay[0]
        detailLivingLabel.text = gorillaLiving[0]
        detailDescriptionTextView.text = gorillaDescription[0]
        detailPersonalityTextView.text = gorillaPersonality[0]
    ...
    func makeButton(x: CGFloat, action: Selector )-> UIButton{
        ...
        button.setBackgroundImage(gorillaImages[0], for: UIControlState.normal)
