...
class AniViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // 名前と画像を表示させる
        detailTitleLabel.text = gorillaTitle[19]
        detailImageView.image = gorillaImages[19]
        detailNameLabel.text = gorillaNames[19]
        detailSexLabel.text = gorillaSex[19]
        detailTypeLabel.text = gorillaType[19]
        detailBirthDayLabel.text = gorillaBirthDay[19]
        detailLivingLabel.text = gorillaLiving[19]
        detailDescriptionTextView.text = gorillaDescription[19]
        detailPersonalityTextView.text = gorillaPersonality[19]
    ...
    func makeButton(x: CGFloat, action: Selector )-> UIButton{
        ...
        button.setBackgroundImage(gorillaImages[19], for: UIControlState.normal)
