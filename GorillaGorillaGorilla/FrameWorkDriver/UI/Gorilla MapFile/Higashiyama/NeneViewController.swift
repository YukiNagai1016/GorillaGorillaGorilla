...
class NeneViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // 名前と画像を表示させる
        detailTitleLabel.text = gorillaTitle[2]
        detailImageView.image = gorillaImages[2]
        detailNameLabel.text = gorillaNames[2]
        detailSexLabel.text = gorillaSex[2]
        detailTypeLabel.text = gorillaType[2]
        detailBirthDayLabel.text = gorillaBirthDay[2]
        detailLivingLabel.text = gorillaLiving[2]
        detailDescriptionTextView.text = gorillaDescription[2]
        detailPersonalityTextView.text = gorillaPersonality[2]
    ...
    func makeButton(x: CGFloat, action: Selector )-> UIButton{
        ...
        button.setBackgroundImage(gorillaImages[2], for: UIControlState.normal)
