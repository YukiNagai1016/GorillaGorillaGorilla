...
class AiViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // 名前と画像を表示させる
        detailTitleLabel.text = gorillaTitle[12]
        detailImageView.image = gorillaImages[12]
        detailNameLabel.text = gorillaNames[12]
        detailSexLabel.text = gorillaSex[12]
        detailTypeLabel.text = gorillaType[12]
        detailBirthDayLabel.text = gorillaBirthDay[12]
        detailLivingLabel.text = gorillaLiving[12]
        detailDescriptionTextView.text = gorillaDescription[12]
        detailPersonalityTextView.text = gorillaPersonality[12]
