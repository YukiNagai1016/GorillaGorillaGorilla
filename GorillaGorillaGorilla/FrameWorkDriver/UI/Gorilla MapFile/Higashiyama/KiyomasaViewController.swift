...
class KiyomasaViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // 名前と画像を表示させる
        detailTitleLabel.text = gorillaTitle[17]
        detailImageView.image = gorillaImages[17]
        detailNameLabel.text = gorillaNames[17]
        detailSexLabel.text = gorillaSex[17]
        detailTypeLabel.text = gorillaType[17]
        detailBirthDayLabel.text = gorillaBirthDay[17]
        detailLivingLabel.text = gorillaLiving[17]
        detailDescriptionTextView.text = gorillaDescription[17]
        detailPersonalityTextView.text = gorillaPersonality[17]
    ...
    func makeButton(x: CGFloat, action: Selector )-> UIButton{
        ...
        button.setBackgroundImage(gorillaImages[17], for: UIControlState.normal)
