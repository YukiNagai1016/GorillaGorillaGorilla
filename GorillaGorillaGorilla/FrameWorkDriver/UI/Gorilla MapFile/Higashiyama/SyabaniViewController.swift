...
class SyabaniViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // 名前と画像を表示させる
        detailTitleLabel.text = gorillaTitle[14]
        detailImageView.image = gorillaImages[14]
        detailNameLabel.text = gorillaNames[14]
        detailSexLabel.text = gorillaSex[14]
        detailTypeLabel.text = gorillaType[14]
        detailBirthDayLabel.text = gorillaBirthDay[14]
        detailLivingLabel.text = gorillaLiving[14]
        detailDescriptionTextView.text = gorillaDescription[14]
        detailPersonalityTextView.text = gorillaPersonality[14]
    ...
    func makeButton(x: CGFloat, action: Selector )-> UIButton{
        ...
        button.setBackgroundImage(gorillaImages[14], for: UIControlState.normal)
