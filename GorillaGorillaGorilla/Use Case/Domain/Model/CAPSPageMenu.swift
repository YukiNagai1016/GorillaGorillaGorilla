    ...
    func configureUserInterface() {
        ...
        for controller in controllerArray {
            ...
            if useMenuLikeSegmentedControl {
                ...
                let itemWidthRect : CGRect = (titleText as NSString).boundingRect(with: CGSize(width: 1000, height: 1000), options: NSStringDrawingOptions.usesLineFragmentOrigin, attributes: [kCTFontAttributeName as NSAttributedString.Key:menuItemFont], context: nil)
    ...
    fileprivate func configureMenuItemWidthBasedOnTitleTextWidthAndCenterMenuItems() {
        ...
        if menuScrollView.contentSize.width < self.view.bounds.width {
            ...
            for (index, menuItem) in menuItems.enumerated() {
                ...
                let itemWidthRect = controllerTitle.boundingRect(with: CGSize(width: 1000, height: 1000), options: NSStringDrawingOptions.usesLineFragmentOrigin, attributes: [kCTFontAttributeName as NSAttributedStringKey as NSAttributedStringKey:menuItemFont], context: nil)
